    ...
    <div className="container">
      ...
      <div className="grid md:grid-cols-3 gap-6 my-4">
        <div className="rounded-xl shadow-md px-4 py-2 hover:scale-105 duration-300">
          ...
          <h3 className="text-md mt-3 mb-3 font-bold">Pristine Water</h3>
          <p className="text-xs text-[#52525B] font-semibold mb-6">
        ...
        <div className="rounded-xl shadow-md px-4 py-2 hover:scale-105 duration-300">
          <img src={icon} alt="" />
          <h3 className="font-bold text-md mt-3 mb-3">
        ...
        <div className="rounded-xl shadow-md px-4 py-2 hover:scale-105 duration-300">
          <img src={credit} alt="" />
          <h3 className="font-bold text-md mt-3 mb-3">Secured Payment </h3>
          <p className="text-xs text-[#52525B] font-semibold mb-6">
        ...
        <div className="rounded-xl shadow-md px-4 py-2 hover:scale-105 duration-300 mt-2">
          <img src={globe} alt="" />
          <h3 className="font-bold text-md mt-3 mb-3">Quick Accessibility </h3>
          <p className="text-xs text-[#52525B] font-semibold mb-6">
        ...
        <div className="rounded-xl shadow-md px-4 py-2 hover:scale-105 duration-300 mt-2">
          <img src={call} alt="" />
          <h3 className="font-bold text-md mt-3 mb-3">24/7 Support </h3>
          <p className="text-xs text-[#52525B] font-semibold mb-6">
            We are committed to enviromental responsibility by implementiong
            sustainable practices.
          </p>
        ...
        <div className="rounded-xl shadow-md px-4 py-2 hover:scale-105 duration-300 mt-2">
          ...
          <h3 className="font-bold text-md mt-3 mb-3">Speedy Delivery </h3>
          <p className="text-xs text-[#52525B] font-semibold mb-6">
